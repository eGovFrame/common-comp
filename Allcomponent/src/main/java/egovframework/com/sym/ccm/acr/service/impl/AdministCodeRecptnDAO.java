...
public class AdministCodeRecptnDAO extends EgovComAbstractDAO {
	...
	public void insertAdministCode(AdministCodeRecptn administCodeRecptn) throws Exception {
		AdministCodeRecptn beforeData = (AdministCodeRecptn) select("AdministCodeRecptnDAO.selectAdministCodeDetail", administCodeRecptn);
	...
	public AdministCodeRecptn selectAdministCodeDetail(AdministCodeRecptn administCodeRecptn) throws Exception {
		return (AdministCodeRecptn) select("AdministCodeRecptnDAO.selectAdministCodeDetail", administCodeRecptn);
	}
    ...
    public List<?> selectAdministCodeRecptnList(AdministCodeRecptnVO searchVO) throws Exception {
        return list("AdministCodeRecptnDAO.selectAdministCodeRecptnList", searchVO);
    }
    ...
    public int selectAdministCodeRecptnListTotCnt(AdministCodeRecptnVO searchVO) throws Exception {
        return (Integer)select("AdministCodeRecptnDAO.selectAdministCodeRecptnListTotCnt", searchVO);
    }
    ...
    public List<?> selectAdministCodeList(AdministCodeRecptnVO searchVO) throws Exception {
        return list("AdministCodeRecptnDAO.selectAdministCodeList", searchVO);
    }
    ...
    public int selectAdministCodeListTotCnt(AdministCodeRecptnVO searchVO) throws Exception {
        return (Integer)select("AdministCodeRecptnDAO.selectAdministCodeListTotCnt", searchVO);
    }
}
