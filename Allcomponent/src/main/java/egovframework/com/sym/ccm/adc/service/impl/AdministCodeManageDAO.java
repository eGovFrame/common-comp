...
public class AdministCodeManageDAO extends EgovComAbstractDAO {
	...
	public AdministCode selectAdministCodeDetail(AdministCode administCode) throws Exception {
		return (AdministCode) select("AdministCodeManageDAO.selectAdministCodeDetail", administCode);
	}
    ...
    public List<?> selectAdministCodeList(AdministCodeVO searchVO) throws Exception {
        return list("AdministCodeManageDAO.selectAdministCodeList", searchVO);
    }
    ...
    public int selectAdministCodeListTotCnt(AdministCodeVO searchVO) throws Exception {
        return (Integer)select("AdministCodeManageDAO.selectAdministCodeListTotCnt", searchVO);
    }
