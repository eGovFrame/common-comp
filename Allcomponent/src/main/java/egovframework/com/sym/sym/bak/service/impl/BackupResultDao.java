...
public class BackupResultDao extends EgovComAbstractDAO {
	...
	public BackupResult selectBackupResult(BackupResult backupResult)
	  throws Exception{
		return (BackupResult)select("BackupResultDao.selectBackupResult", backupResult);
	}
	...
	public List<?> selectBackupResultList(BackupResult searchVO)
	  throws Exception{
		return list("BackupResultDao.selectBackupResultList", searchVO);
	}
	...
	public int selectBackupResultListCnt(BackupResult searchVO)
	  throws Exception{
		return (Integer)select("BackupResultDao.selectBackupResultListCnt", searchVO);
	}
