...
public class BackupOpertDao extends EgovComAbstractDAO {
	...
	public BackupOpert selectBackupOpert(BackupOpert backupOpert)
	  throws Exception{
		BackupOpert result = (BackupOpert)select("BackupOpertDao.selectBackupOpert", backupOpert);
		// 스케줄요일정보를 가져온다.
		List<BackupSchdulDfk> dfkSeList = (List<BackupSchdulDfk>) list("BackupOpertDao.selectBackupSchdulDfkList", result.getBackupOpertId());
	...
	public List<?> selectBackupOpertList(BackupOpert searchVO)
	  throws Exception{
		List<?> resultList = list("BackupOpertDao.selectBackupOpertList", searchVO);
	...
	public int selectBackupOpertListCnt(BackupOpert searchVO)
	  throws Exception{
		return (Integer)select("BackupOpertDao.selectBackupOpertListCnt", searchVO);
	}
