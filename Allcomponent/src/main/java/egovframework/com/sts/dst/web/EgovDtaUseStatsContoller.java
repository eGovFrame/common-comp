...
public class EgovDtaUseStatsContoller {
	 ...
	 * @return String
	 */
	@IncludedInfo(name="자료이용현황통계", listUrl="/sts/dst/selectDtaUseStatsList.do", order = 161 ,gid = 30)
	@RequestMapping("/sts/dst/selectDtaUseStatsList.do")
	public String selectDtaUseStatsList(@ModelAttribute("dtaUseStatsVO") DtaUseStatsVO dtaUseStatsVO, 
