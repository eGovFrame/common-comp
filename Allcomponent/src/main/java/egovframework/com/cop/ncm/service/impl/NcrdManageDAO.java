...
public class NcrdManageDAO extends EgovComAbstractDAO {
	...
	vo = (NameCardVO)select("NcrdManageDAO.selectNcrdItem", nameCard);
	return vo;
    }
	...
	return (Integer)select("NcrdManageDAO.selectNcrdItemListCnt", ncrdVO);
    }
	...
	return (Integer)select("NcrdManageDAO.selectNcrdUseInfsCnt", ncrdUser);
    }
	...
	return (Integer)select("NcrdManageDAO.selectMyNcrdItemListCnt", ncrdVO);
    }
}
