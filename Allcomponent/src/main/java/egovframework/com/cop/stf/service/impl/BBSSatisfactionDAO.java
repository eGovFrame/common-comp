...
public class BBSSatisfactionDAO extends EgovComAbstractDAO {
	...
	return (Integer)select("BBSSatisfactionDAO.selectSatisfactionListCnt", satisfactionVO);
    }
	...
	return (Satisfaction)select("BBSSatisfactionDAO.selectSatisfaction", satisfactionVO);
    }
	...
	return (String)select("BBSSatisfactionDAO.getSatisfactionPassword", satisfaction);
    }
	...
	return (Float)select("BBSSatisfactionDAO.getSummary", satisfactionVO);
    }
}
