...
public class KnoManagementDAO extends EgovComAbstractDAO {
	...
	public List<?> selectKnoManagementList(KnoManagementVO searchVO) throws Exception {
		return  list("KnoManagementDAO.selectKnoManagementList", searchVO);
	}
	...
	public int selectKnoManagementTotCnt(KnoManagementVO searchVO) throws Exception {
		return  (Integer)select("KnoManagementDAO.selectKnoManagementTotCnt", searchVO);
	}
	...
	public KnoManagement selectKnoManagement(KnoManagement knoManagement) throws Exception {
		return (KnoManagement)select("KnoManagementDAO.selectKnoManagement", knoManagement);
	}
