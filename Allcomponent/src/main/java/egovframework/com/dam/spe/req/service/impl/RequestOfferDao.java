...
public class RequestOfferDao extends EgovComAbstractDAO {
    ...
    public int selectRequestOfferDelCnt(Map<?, ?> map) throws Exception {
    	return (Integer)select("RequestOffer.selectRequestOfferDelCnt", map);
    }
    ...
    public int selectRequestOfferSpeCnt(Map<?, ?> map) throws Exception {
    	return (Integer)select("RequestOffer.selectRequestOfferSpeCnt", map);
    }
    ...
    public List<?> selectRequestOfferList(RequestOfferVO RequestOfferVO) throws Exception {
    	return list("RequestOffer.selectRequestOffer",RequestOfferVO);
    ...
    public int selectRequestOfferListCnt(RequestOfferVO RequestOfferVO) throws Exception {
    	return (Integer)select("RequestOffer.selectRequestOfferCnt", RequestOfferVO);
    }
    ...
    public RequestOfferVO selectRequestOfferDetail(RequestOfferVO RequestOfferVO) throws Exception {
    	return (RequestOfferVO)select("RequestOffer.selectRequestOfferDetail", RequestOfferVO);
    }
	...
	public void insertRequestOffer(RequestOfferVO RequestOfferVO) throws Exception {
    	if(RequestOfferVO.getCmd().equals("save")){
    		...
    		int nSeq = (Integer)select("RequestOffer.selectRequestOfferReplySeq", RequestOfferVO);

    		Map<?, ?> mapAnsParents = (Map<?, ?>)select("RequestOffer.selectRequestOfferReplyaAnsParents", RequestOfferVO);
    		...
    		if(mapAnsParents != null){
	    		...
	    		while(true){
	    			...
	    			mapAnsParents = (Map<?, ?>)select("RequestOffer.selectRequestOfferReplyaAnsParentsSearch", hmParam);
