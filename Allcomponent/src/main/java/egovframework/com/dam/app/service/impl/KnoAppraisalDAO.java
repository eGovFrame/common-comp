...
public class KnoAppraisalDAO extends EgovComAbstractDAO {
	...
	public List<?> selectKnoAppraisalList(KnoAppraisalVO searchVO) throws Exception {
		return  list("KnoAppraisalDAO.selectKnoAppraisalList", searchVO);
	}
	...
	public int selectKnoAppraisalTotCnt(KnoAppraisalVO searchVO) throws Exception {
		return  (Integer)select("KnoAppraisalDAO.selectKnoAppraisalTotCnt", searchVO);
	}
	...
	public KnoAppraisal selectKnoAppraisal(KnoAppraisal knoAppraisal) throws Exception {
		return (KnoAppraisal)select("KnoAppraisalDAO.selectKnoAppraisal", knoAppraisal);
	}
