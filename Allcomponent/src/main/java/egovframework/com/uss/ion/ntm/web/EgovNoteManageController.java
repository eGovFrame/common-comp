...
public class EgovNoteManageController {
    ...
    public String EgovNoteRecptnRegistForm(NoteManage noteManage, @RequestParam Map<?, ?> commandMap,ModelMap model) throws Exception {
    ...
    public String EgovNoteRecptnRegist(
        ...
        //아이디 설정
        noteManage.setFrstRegisterId(loginVO.getUniqId());
        noteManage.setLastUpdusrId(loginVO.getUniqId());
