...
public class EgovNoteTrnsmitController {
    ...
    public String EgovNoteTrnsmitList(
        ...
        if(sCmd.equals("del")){
	        ...
	        if(commandMap.get("checkList") instanceof String){
	            ...
	            noteTrnsmit.setFrstRegisterId(loginVO.getUniqId());
	            noteTrnsmit.setLastUpdusrId(loginVO.getUniqId());
        ...
        //발시자설정
        searchVO.setTrnsmiterId(loginVO.getUniqId());
    ...
    public String EgovNoteTrnsmitDetail(
            ...
            if(sCmd.equals("del")){
            	...
            	searchVO.setLastUpdusrId(loginVO.getUniqId());
