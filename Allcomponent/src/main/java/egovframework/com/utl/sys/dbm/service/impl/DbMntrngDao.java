...
public class DbMntrngDao extends EgovComAbstractDAO {
	...
	public DbMntrng selectDbMntrng(DbMntrng dbMntrng)
	  throws Exception{
		return (DbMntrng)select("DbMntrngDao.selectDbMntrng", dbMntrng);
	}
	...
	public DbMntrngLog selectDbMntrngLog(DbMntrngLog dbMntrngLog)
	  throws Exception{
		return (DbMntrngLog)select("DbMntrngDao.selectDbMntrngLog", dbMntrngLog);
	}
	...
	public int selectDbMntrngListCnt(DbMntrng searchVO)
	  throws Exception{
		return (Integer)select("DbMntrngDao.selectDbMntrngListCnt", searchVO);
	}
	...
	public int selectDbMntrngLogListCnt(DbMntrngLog searchVO)
	  throws Exception{
		return (Integer)select("DbMntrngDao.selectDbMntrngLogListCnt", searchVO);
	}
