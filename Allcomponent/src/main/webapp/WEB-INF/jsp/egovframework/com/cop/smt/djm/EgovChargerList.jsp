...
<div id="border" style="width:730px">
	...
	<tbody>
	 <tr>
	  <td width="25%" class="title_left">
	   <img src="<c:url value='/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" style="vertical-align: middle" alt="제목아이콘이미지">&nbsp;담당자 선택</td>
		<td width="30%" >
	  ...
	  <th width="10%">
	   <table border="0" cellspacing="0" cellpadding="0">
	    <tr>
	      <td><span class="button"><input type="submit" value="조회" onclick="fn_egov_select_charger('1'); return false;"></span></td>
	    </tr>
	   </table>
	  </th>  
	 </tr>
	...
	<table width="100%" cellpadding="8" class="table-list" summary="이 표는 담당자정보를 제공하며, 부서, 직위, 사번, 사원명  정보로 구성되어 있습니다." >
	<caption>담당자목록</caption> 
	 <thead>
	  <tr>
		 ...
		 <c:forEach var="result" items="${resultList}" varStatus="status">
		  <tr>
		    ...
		    <td class="lt_text3" nowrap>
				<span class="link"><input type="submit" value="선택" onclick="javascript:fn_egov_inqire_charger('<c:out value="${result.uniqId}"/>', '<c:out value="${result.emplNo}"/>', '<c:out value="${result.emplyrNm}"/>', '<c:out value="${result.orgnztNm}"/>'); return false;"></span>
			</td>
		  </tr>
		 </c:forEach>	  
