...
<form:form commandName="wikMnthngReprtVO" name="wikMnthngReprtVO" method="post" action="${pageContext.request.contextPath}/cop/smt/wmr/insertWikMnthngReprt.do' />" enctype="multipart/form-data">
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="1" class="table-register" summary="이 표는 주간/월간보고 정보를 등록하기 위한 표이며, 보고유형, 보고일자, 해당일자, 작성자, 보고대상자, 보고서제목, 금주보고내용, 차주보고내용, 특이사항, 파일첨부  정보로 구성되어 있습니다 .">
	  ...
	  <tr>
	    ...
	    <td width="80%" >
			...
			<tr>
				...
				<img src="<c:url value='/images/egovframework/com/cmm/icon/search.gif' />" style="border:0px" alt="보고대상자 검색" title="보고대상자 검색">
				</a>
				</td>
			</tr>
			</table>
	...
	<tr>
	  <td><span class="button"><input type="submit" value="<spring:message code="button.save" />" onclick="fn_egov_insert_wikmnthngreprt(); return false;"></span></td>
      <td>&nbsp;&nbsp;</td>
