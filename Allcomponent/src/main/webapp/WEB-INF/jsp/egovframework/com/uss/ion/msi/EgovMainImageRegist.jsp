...
<table width="100%" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="40%" class="title_left">
   <h1><img src="<c:url value='/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="middle" alt="제목아이콘이미지">&nbsp;메인화면이미지 등록</h1>
  </td>
 </tr>
</table>

<table width="100%" cellpadding="8" class="table-line" summary="메인화면이미지를 등록한다.">
  ...
  <tr>
    ...
    <td class="lt_text" nowrap><input name="imageId" id="imageId" title="이미지ID" type="text" value="<c:out value='${mainImage.imageId}'/>" size="20" class="readOnlyClass" readonly></td>
  </tr>
  <tr>
    ...
    <td class="lt_text" nowrap><input name="imageNm" id="imageNm" title="이미지명" type="text" value="<c:out value='${mainImage.imageNm}'/>" maxLength="10" size="20" >&nbsp;<form:errors path="imageNm" /></td>
  </tr>
  <tr>
  ...
  <tr>
    <th class="required_text" width="20%" nowrap>등록일시<img src="<c:url value='/images/egovframework/com/cmm/icon/no_required.gif' />" width="15" height="15" alt="선택입력표시"></th>
    <td class="lt_text" nowrap><input name="regDate" id="regDate" type="text" value="<c:out value="${loginScrinImage.regDate}"/>" maxLength="20" size="20" class="readOnlyClass" readonly title="등록일시"></td>
  </tr>
</table>
  ...
  <tr>
    <td align="center">
	   <table border="0" cellspacing="0" cellpadding="0">
	    <tr>
	      <td><span class="button"><input type="submit" value="<spring:message code="button.save" />" onclick="fncMainImageInsert(); return false;"></span></td>
	      <td>&nbsp;&nbsp;</td>
