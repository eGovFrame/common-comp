...
function fn_egov_list(){
    ...
    varForm.action = "/utl/sys/trm/getTrsmrcvMntrngLogList.do";
    varForm.submit()
}
</script>
</head>
...
<form name="trsmrcvMntrngLogForm"  id="trsmrcvMntrngLogForm" action="/utl/sys/trm/getTrsmrcvMntrngLogList.do" method="post">
