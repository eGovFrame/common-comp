			...
			<form name="Form" action="" method="post">
				<input name="processNm" type="hidden">
					<table width="700" cellpadding="8" class="table-search" border="0">
			 			<tr>
			  				<td width="100%" class="title_left">
			   				<h1><img src="${ImgUrl}icon/tit_icon.gif" width="16" height="16" hspace="3" align="absmiddle" alt="">&nbsp;프로세스모니터링로그 상세조회</h1></td>
			 			</tr>
					</table>
					...
					<caption>프로세스모니터링로그 상세조회</caption>
					  	...
					  	<tr> 
					    	<th scope="row" width="20%" height="23" class="required_text">프로세스명<img src="${ImgUrl}icon/required.gif" alt="필수입력표시"  width="15" height="15"></th>
