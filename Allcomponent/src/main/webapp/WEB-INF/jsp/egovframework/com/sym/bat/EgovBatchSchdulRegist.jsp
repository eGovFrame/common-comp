...
function fn_egov_save(){
    var varForm = document.getElementById("batchSchdul");
    varForm.action =  "/sym/bat/addBatchSchdul.do";
...
<!-- 상단타이틀 -->
<form:form commandName="batchSchdul"  action="/sym/bat/addBatchSchdul.do" method="post">
...
<table width="100%" cellpadding="8" class="table-search" border="0" summary="상단 타이틀을 제공한다.">
 <tr>
  <td width="100%"class="title_left">
   <h1><img src="${imgUrl}icon/tit_icon.gif" width="16" height="16" hspace="3" style="vertical-align: middle" alt="">&nbsp;배치스케줄 등록</h1></td>
 </tr>
</table>
<!--  줄간격조정  -->
...
<table width="100%" border="0" cellpadding="0" cellspacing="1" class="table-register" summary="배치스케줄등록을 위한 테이블.">
  ...
  <tr>
    ...
    <td nowrap>
        ...
        <a href="#LINK" onClick="javascript:fn_egov_popup_batch_opert_list(); return false;" style="selector-dummy: expression(this.hideFocus=false);"><img src="<c:url value='/images/egovframework/com/cmm/icon/search2.gif' />"
