...
<script type="text/javascript" src="<c:url value='/js/egovframework/com/uss/olh/hpc/EgovHpcm.js' />"></script>
...
<!-- 상단타이틀 -->
<form:form commandName="hpcmManageVO" action="${pageContext.request.contextPath}/uss/olh/hpc/HpcmCnUpdt.do" method="post">

<!-- 상단 타이틀  영역 -->
<table width="100%" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="100%"class="title_left">
   <h1><img src="<c:url value='/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="left" alt="제목아이콘이미지">&nbsp;도움말수정</h1></td>
 </tr>
</table>
...
<!-- 등록  폼 영역  -->
<table width="90%" border="0" cellpadding="0" cellspacing="1" class="table-register" summary="도움말에 대한 정보를 수정합니다.">
<caption>도움말수정</caption>
  <tr>
    <th scope="row" height="23" class="required_text" ><label for="hpcmSeCode">도움말구분</label><img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif' />" width="15" height="15" alt="필수항목"></th>
    <td>
...
<tr>
  <td><span class="button"><input type="submit" value="<spring:message code="button.update" />" onclick="fn_egov_updt_hpcmcn(document.forms[0],'<c:out value="${result.hpcmId}"/>'); return false;"></span></td>
  <td>&nbsp;&nbsp;</td>
