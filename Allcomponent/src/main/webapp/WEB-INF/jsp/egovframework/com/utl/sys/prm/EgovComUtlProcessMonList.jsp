...
<html lang="ko">
	<head>
		...
		function fnSearchLog(){
			location.href = "/utl/sys/prm/EgovComUtlProcessMonLogList.do";
		}
		-->
		</script>
	</head>
			...
			<table width="100%" cellpadding="8" class="table-search" border="0">
 				<tr>
  					<td width="30%" class="title_left">
   					<h1><img src="<c:out value="${ImgUrl}"/>icon/tit_icon.gif" width="16" height="16" hspace="3" align="absmiddle" alt="">&nbsp;프로세스모니터링 목록</h1></td>
					<td width="20%">
  					...
  					<th width="30%">
   						<table border="0" cellspacing="0" cellpadding="0">
	    					<tr> 
							    ...
							    <td class="btnBackground"><a href="/utl/sys/prm/EgovComUtlProcessMonRegist.do"><spring:message code="button.create" /></a></td>
				...
				<tbody>					  										
					<c:forEach items="${resultList}" var="resultInfo" varStatus="status">
						<tr>
							...
							<td class="lt_text3">
							<a href="/utl/sys/prm/EgovComUtlProcessMon.do?pageIndex=${searchVO.pageIndex}&amp;processNm=${resultInfo.processNm}"><c:out value="${resultInfo.processNm}"/></a>								
							</td>						
