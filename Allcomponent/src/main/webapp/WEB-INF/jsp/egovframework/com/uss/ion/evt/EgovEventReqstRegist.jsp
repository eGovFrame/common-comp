...
<!-- ********** 여기서 부터 본문 내용 *************** -->
<!-- 상단타이틀 -->
<form:form commandName="eventManage" name="eventManage" method="post" action="${pageContext.request.contextPath}/uss/ion/evt/insertEventManage.do">
<input name="cmd" type="hidden" value="insert"/>

<table width="100%" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="30%"class="title_left">
   <h1><img src="<c:url value='/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" style="vertical-align: middle" alt="제목아이콘이미지">&nbsp;행사  등록</h1></td>
  <td width="60%">&nbsp;</td>
...
<caption>행사관리 등록</caption>
  <tr>
    <th width="20%" height="23" class="required_text"  scope="row"><label for="eventSe">행사구분</label><img src="/images/egovframework/com/cmm/icon/required.gif" alt="필수입력표시"  width="15" height="15"></th>
  ...
  <tr>
    <th width="20%" height="23" class="required_text"  scope="row"><label for="eventNm">행사명</label><img src="/images/egovframework/com/cmm/icon/required.gif" alt="필수입력표시"  width="15" height="15"></th>
    <td width="80%" >
