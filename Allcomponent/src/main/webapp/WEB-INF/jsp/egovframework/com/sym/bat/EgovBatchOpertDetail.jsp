...
function fn_egov_list(){
    ...
    varForm.action = "/sym/bat/getBatchOpertList.do";
    varForm.submit()
}
/* ********************************************************
 * 수정화면으로  바로가기
...
function fn_egov_update_view(){
    ...
    varForm.action = "/sym/bat/getBatchOpertForUpdate.do";
    varForm.submit();
}
/* ********************************************************
 * 삭제 처리
 ******************************************************** */
 function fn_egov_delete(){
        ...
        if(confirm("<spring:message code='common.delete.msg' />")){
            vForm.action = "/sym/bat/deleteBatchOpert.do";
            vForm.submit();
        }
}
</script>
    ...
    <table width="100%" cellpadding="8" class="table-search" border="0" summary="제목테이블">
     <tr>
      <td width="100%"class="title_left">
       <h1><img src="<c:out value='/images/egovframework/com/cmm/icon/tit_icon.gif'/>" width="16" height="16" hspace="3" style="vertical-align: middle" alt="">&nbsp;배치작업 상세조회</h1></td>
     </tr>
    </table>
    <!--  줄간격조정  -->
