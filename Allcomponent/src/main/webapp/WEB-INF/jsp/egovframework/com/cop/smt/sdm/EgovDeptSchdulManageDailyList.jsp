...
<HEAD>
	...
	******************************************************** */
	...
	function fnEgovSchdulSe(setValue) {
		...
		location.href="<c:url value='/cop/smt/sdm/EgovDeptSchdulManageDailyList.do' />?year=<%=iNowYear%>&month=<%=iNowMonth%>&day=<%=iNowDay%>&searchCondition=SCHDUL_SE&searchKeyword=" + setValue;
	}
...
<td height="60">
    ...
    <td>
		...
		<td>
			...
			<a href="<c:url value='/cop/smt/sdm/EgovDeptSchdulManageDailyList.do' />?year=<%=iNowYear-1%>&amp;month=<%=iNowMonth%>&amp;day=<%=iNowDay%>">
			<img src="<c:url value='/images/egovframework/com/cmm/icon/iconicoPrev.gif' />" align="middle" style="margin-right:4px;border:0px;" alt="이전으로가기아이콘표시">
			</a>
			<%=iNowYear%>년
			<a href="<c:url value='/cop/smt/sdm/EgovDeptSchdulManageDailyList.do' />?year=<%=iNowYear+1%>&amp;month=<%=iNowMonth%>&amp;day=<%=iNowDay%>">
			<img src="<c:url value='/images/egovframework/com/cmm/icon/iconicoNxt.gif' />" align="middle" style="margin-left:4px;border:0px;" alt="다음으로가기아이콘표시">
			</a>
			</td>
			<td width="80" align="center">
			<%if(iNowMonth > 0 ){ %>
			<a href="<c:url value='/cop/smt/sdm/EgovDeptSchdulManageDailyList.do' />?year=<%=iNowYear%>&amp;month=<%=iNowMonth-1%>&amp;day=<%=iNowDay%>">
			<img src="<c:url value='/images/egovframework/com/cmm/icon/iconicoPrev.gif' />" align="middle" style="margin-right:4px;border:0px;" alt="이전으로가기아이콘표시">
			</a>
			<%}%>
			<%=iNowMonth+1%>월
			...
			<td width="80" align="center">
			<%if(iNowDay > 1 ){ %>
			<a href="<c:url value='/cop/smt/sdm/EgovDeptSchdulManageDailyList.do' />?year=<%=iNowYear%>&amp;month=<%=iNowMonth%>&amp;day=<%=iNowDay-1%>">
			<img src="<c:url value='/images/egovframework/com/cmm/icon/iconicoPrev.gif' />" align="middle" style="margin-right:4px;border:0px;" alt="이전으로가기아이콘표시">
			</a>
			<%}%>
			<%=iNowDay%>일
...
<table width="100%"  border="0" cellpadding="1" cellspacing="1" bgcolor="#828486" style="font-size:8px;font-weight: bold;">
 <tr>
		<td width="240px" bgcolor="E0E0E0" align="center" height="30px" style="font-size:12px;font-weight: bold;">시간</td>
