...
<table width="100%" border="0" cellpadding="0" cellspacing="1" class="table-register" summary=" 수정을 제공한다.">
  ...
  <tr>
    <th width="20%" height="23" class="required_text" nowrap ><label id="srchwrdManageId">최근검색어관리번호</label><img src="${ImgUrl}icon/no_required.gif" alt="비필수입력" title="비필수입력" width="15" height="15"></th>
    <td width="80%">
