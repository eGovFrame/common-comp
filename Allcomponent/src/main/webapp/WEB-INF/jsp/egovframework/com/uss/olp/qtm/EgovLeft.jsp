...
<tr>
	...
	<tr>
		<td align="center" class="tdG" nowrap><a href="<c:url value='/uss/olp/qtm/EgovQustnrTmplatManageList.do' />" target="content">설문템플릿관리</a></td>
	</tr>
	<tr>
		<td align="center" class="tdG" nowrap><a href="<c:url value='/uss/olp/qmc/EgovQustnrManageList.do' />" target="content">설문지정보관리</a></td>
	</tr>
	<tr>
		<td align="center" class="tdG" nowrap><a href="<c:url value='/uss/olp/qqm/EgovQustnrQestnManageList.do' />" target="content">설문문항관리</a></td>
	</tr>
	<tr>
		<td align="center" class="tdG" nowrap><a href="<c:url value='/uss/olp/qim/EgovQustnrItemManageList.do' />" target="content">설문항목관리</a></td>
	</tr>
	<tr>
		<td align="center" class="tdG" nowrap><a href="<c:url value='/uss/olp/qnn/EgovQustnrRespondInfoManageList.do' />" target="content">설문참여</a></td>
	</tr>
	<tr>
		<td align="center" class="tdG" nowrap><a href="<c:url value='/uss/olp/qri/EgovQustnrRespondInfoList.do' />" target="content">설문조사(응답결과)관리</a></td>
	</tr>
	<tr>
		<td align="center" class="tdG" nowrap><a href="<c:url value='/uss/olp/qrm/EgovQustnrRespondManageList.do' />" target="content">설문응답자정보관리</a></td>
	</tr>
	</table>
