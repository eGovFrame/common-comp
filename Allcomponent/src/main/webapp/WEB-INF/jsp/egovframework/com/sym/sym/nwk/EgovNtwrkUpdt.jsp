...
<table border="0">
  <tr>
    ...
    <table width="100%" class="table-search" border="0">
     <tr>
      <td width="700" class="title_left"><h1><img src="<c:url value='/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="middle" style="vertical-align:middle;" alt="">&nbsp;네트워크 수정</h1></td>
     </tr>
     <tr>
    ...
    <table width="100%" cellpadding="1" class="table-register" summary="네트워크 정보를 수정한다.">
      ...
      <tr>
        <th class="required_text" width="20%" scope="row" nowrap>관리항목<img src="/images/egovframework/com/cmm/icon/required.gif" width="15" height="15" alt="" /></label></th>
      ...
      <tr>
        <th class="required_text" width="20%" nowrap>등록일자<img src="/images/egovframework/com/cmm/icon/required.gif" width="15" height="15" alt=""></th>
