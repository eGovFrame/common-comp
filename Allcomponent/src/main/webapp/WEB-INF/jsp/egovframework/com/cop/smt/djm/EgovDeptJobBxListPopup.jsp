...
<!-- ------------------------------------------------------------------ iframe -->
<iframe id="DeptJobBxListView" src="<c:url value='/cop/smt/djm/selectDeptJobBxList.do' />?popupCnd=Y" width="100%" height="475px" frameborder="0" scrolling="no" marginwidth="0" marginheight="0" title="부서업무함 목록">
</iframe>
</DIV>
</body>
</html>
