<%--
  Class Name : EgovOnlinePollManageModify.jsp
  Description : 온라인POLL관리 수정 페이지
...
<!-- 상단타이틀 -->
<form:form commandName="onlinePollManage" name="onlinePollManage" action="" method="post">
<!-- 상단 타이틀  영역 -->
<table width="100%" cellpadding="8" class="table-search" border="0" summary="상단 타이틀을 제공한다.">
 <tr>
  <td width="100%"class="title_left">
   <img src="<c:url value='/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" align="middle" alt="제목아이콘이미지">&nbsp;온라인POLL관리 수정</td>
 </tr>
</table>
<!-- 줄간격조정  -->
...
<table width="100%" border="0" cellpadding="0" cellspacing="1" class="table-register" summary="온라인POLL관리 입력을 제공한다..">
  <tr>
    <th width="20%" height="23" class="required_text" nowrap ><label id="IdPollNm">POLL명</label>
  ...
  <tr>
    <th width="20%" height="23" class="required_text" nowrap ><label id="IdPollBeginDe">POLL시작일자</label>
    <img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" width="15" height="15" alt="필수입력표시"></th>
    <td width="80%">
      ...
      <img src="<c:url value='/images/egovframework/com/cmm/icon/bu_icon_carlendar.gif' />" align="middle" style="border:0px" alt="POLL시작일자" title="POLL시작일자">
      <form:errors path="pollBeginDe" cssClass="error"/>
      </a>
    </td>
  </tr>
  <tr>
    <th width="20%" height="23" class="required_text" nowrap ><label id="IdPollEndDe">POLL종료일자</label>
    <img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" width="15" height="15" alt="필수입력표시"></th>
    <td width="80%">
      ...
      <img src="<c:url value='/images/egovframework/com/cmm/icon/bu_icon_carlendar.gif' />" align="middle"  style="border:0px" alt="POLL종료일자" title="POLL종료일자">
      </a>
      <form:errors path="pollEndDe" cssClass="error"/>
    </td>
  </tr>
  <tr>
    <th height="23" class="required_text" ><label id="IdPollKindCode">POLL구분</label>
    <img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" width="15" height="15" alt="필수입력표시"></th>
    <td>
  ...
  <tr>
    <th width="20%" height="23" class="required_text" nowrap ><label id="IdPollDsuseYn">POLL페기유무</label>
    <img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" width="15" height="15" alt="필수입력표시"></th>
    <td width="80%">

   		<input type="radio" name="pollDsuseYn" value="N" <c:if test="${onlinePollManage.pollDsuseYn eq 'N'}">checked</c:if>>N
   		<input type="radio" name="pollDsuseYn" value="Y" <c:if test="${onlinePollManage.pollDsuseYn eq 'Y'}">checked</c:if>>Y

    </td>
  </tr>

  <tr>
    <th width="20%" height="23" class="required_text" nowrap ><label id="IdPollAutoDsuseYn">POLL자동페기유무</label>
    <img src="<c:url value='/images/egovframework/com/cmm/icon/required.gif'/>" width="15" height="15" alt="필수입력표시"></th>
    <td width="80%">
   		<input type="radio" name="pollAutoDsuseYn" value="N" <c:if test="${onlinePollManage.pollAutoDsuseYn eq 'N'}">checked</c:if>>N
   		<input type="radio" name="pollAutoDsuseYn" value="Y" <c:if test="${onlinePollManage.pollAutoDsuseYn eq 'Y'}">checked</c:if>>Y
    </td>
  </tr>
</table>
