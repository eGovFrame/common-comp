<%--
  Class Name : EgovLeaderSchdulModify.jsp
  Description : 간부일정관리 수정 페이지
...
<title>간부일정관리 수정</title>
</head>
<body onLoad="fn_egov_init_LeaderSchdul();">
<noscript class="noScriptTitle">자바스크립트를 지원하지 않는 브라우저에서는 일부 기능을 사용하실 수 없습니다.</noscript>
<div id="content" style="width:712px">
<form:form commandName="leaderSchdulVO" name="leaderSchdulVO" action="${pageContext.request.contextPath}/cop/smt/lsm/mng/updateLeaderSchdul.do" method="post">
<!-- 상단 타이틀  영역 -->
<table width="100%" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="100%"class="title_left">
   <h1><img src="${ImgUrl}icon/tit_icon.gif" width="16" height="16" hspace="3" style="vertical-align: middle" alt="">&nbsp;간부일정관리 수정</h1></td>
 </tr>
</table>
<!-- //상단 타이틀  영역 -->
<!-- 줄간격조정  -->
...
<!-- //줄간격조정  -->
<table width="100%" border="0" cellpadding="0" cellspacing="1" class="table-register" summary="이 표는 간부일정정보를  수정하기 위한 표이며, 일정구분, 간부, 일정명, 일정내용, 일정장소, 반복구분, 날짜/시간, 담당자 정보로 구성되어 있습니다 .">
  <tr>
 ...
 <tr>
  ...
  <tr>
    <th scope="row" height="23" class="required_text" ><label for="schdulCn">일정내용</label><img src="${ImgUrl}icon/required.gif" width="15" height="15" alt="필수항목"></th>
    <td>
