...
<table width="717" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="100%" class="title_left">
   <img src="<c:url value='/images/egovframework/com/sym/prm/icon/tit_icon_pop.gif' />" width="16" height="16" hspace="3" alt="">&nbsp;변경처리내역</td>
 </tr>
</table>
...
<table width="717" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="100%" class="title_left">
   <img src="<c:url value='/images/egovframework/com/sym/prm/icon/tit_icon_pop.gif' />" width="16" height="16" hspace="3" alt="" /><label for="rqesterCn">&nbsp;변경요청내역</label></td>
 </tr>
</table>
