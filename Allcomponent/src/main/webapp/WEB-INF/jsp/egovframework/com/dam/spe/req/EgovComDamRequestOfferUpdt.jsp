...
function fn_egov_save_RequestOffer(){
	...
	if(confirm("<spring:message code="common.save.msg" />")){
		...
		vFrom.action = "/dam/spe/req/updtRequestOfferActor.do";
...
<!-- 등록폼 시작  -->
<form:form commandName="requestOfferVO" name="requestOfferVO" action="/dam/spe/req/updtRequestOffer.do" method="post" enctype="multipart/form-data" >
	<%-- 상산 타이틀 --%>
<table width="100%" cellpadding="1" class="table-search" border="0">
<tr>
	<td class="title_left">
		<h1><img src="<c:out value="${ImgUrl}"/>icon/tit_icon.gif" width="16" height="16" hspace="3" style="vertical-align:middle; display:inline-block;" alt="">&nbsp;지식 정보제공/정보요청 수정</h1>
	</td>
	<td width="150px"></td>  
</tr>
</table>
