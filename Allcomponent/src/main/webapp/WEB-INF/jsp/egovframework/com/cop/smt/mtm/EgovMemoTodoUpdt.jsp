<%
/**
 * @Class Name : EgovMemoTodoUpdt.jsp
 * @Description : 메모할일 수정
...
<script type="text/javascript">
	...
	function fn_egov_update_memotodo() {
		...
		if (confirm('<spring:message code="common.regist.msg" />')) {
			document.memoTodoVO.action = "<c:url value='/cop/smt/mtm/updateMemoTodo.do'/>";
...
<form:form commandName="memoTodoVO" name="memoTodoVO" method="post" action="${pageContext.request.contextPath}/cop/smt/mtm/updateMemoTodo.do' />">
	...
	<table width="100%" border="0" cellpadding="0" cellspacing="1" class="table-register"  summary="이 표는 메모할일 정보를  수정하기 위한 표이며, 할일일시, 작성자, 할일제목, 할일내용 정보로 구성되어 있습니다 .">
	<caption>메모할일 수정</caption>
	<tbody>
	  <tr>
	...
	<tr>
	  <td><span class="button"><input type="submit" value="<spring:message code="button.save" />" onclick="fn_egov_update_memotodo(); return false;"></span></td>
      <td>&nbsp;&nbsp;</td>
