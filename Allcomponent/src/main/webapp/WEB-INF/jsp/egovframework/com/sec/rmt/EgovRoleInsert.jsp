...
<table width="100%" cellpadding="8" class="table-line" summary="롤 등록 테이블입니다.롤 코드,롤 명,롤 패턴,설명,롤 타입,롤 Sort,등록일자의 정보를 담고 있습니다.">
  ...
  <tr>
    <th class="required_text" width="20%" scope="row"  nowrap="nowrap">설명<img src="<c:url value='/images/egovframework/com/cmm/icon/no_required.gif' />" width="15" height="15" alt="선택입력표시"></th>
  ...
  <tr>
    <th class="required_text" width="20%" scope="row"  nowrap="nowrap">등록일자<img src="<c:url value='/images/egovframework/com/cmm/icon/no_required.gif' />" width="15" height="15" alt="선택입력표시"></th>
