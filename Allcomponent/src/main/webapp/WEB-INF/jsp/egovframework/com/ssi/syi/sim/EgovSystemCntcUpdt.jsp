...
<table width="700" cellpadding="8" class="table-search" border="0" summary="상단 타이틀을 제공한다.">
 <tr>
  <td width="100%"class="title_left">
   <img src="<c:url value='/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" style="vertical-align: middle" alt="제목아이콘이미지">&nbsp;시스템연계 수정</td>
 </tr>
</table>
<!-- 줄간격조정  -->
...
<table width="700" border="0" cellpadding="0" cellspacing="1" class="table-register" summary="시스템연계  수정을 제공한다.">
  ...
  <tr>
    ...
    <td width="80%" nowrap>
	  ...
	  <a href="javascript:fn_egov_NormalCalendar(document.systemCntc, document.systemCntc.validBeginDe, document.systemCntc.v_validBeginDe);" style="selector-dummy:expression(this.hideFocus=false);"><img src="<c:url value='/images/egovframework/com/cmm/icon/bu_icon_carlendar.gif' />" alt="달력창팝업버튼이미지"></a>
    </td>
  </tr>
  <tr>
