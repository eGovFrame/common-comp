						...
						<td><table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td height="22" align="right">
									<a href="javascript:fn_egov_loadArticleList('<c:out value="${bbsList[0].bbsId}" />','<c:out value="${bbsList[0].bbsAttrbCode}" />');"><img src="<c:url value='/images/egovframework/com/cop/tpl/more_08.gif' />" width="36" height="12" alt="더보기이미지아이콘" /></a>
								</td>
							</tr>
						</table></td>
					</tr>
					<tr>
						<td><table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td width="100%" style="background-image : url(${pageContext.request.contextPath}/images/egovframework/com/cop/tpl/right_gap.gif);" ><img src="<c:url value='/images/egovframework/com/cop/tpl/right_gap.gif' />" width="9" height="9" alt="여백이미지" ></td>
								<td><img src="<c:url value='/images/egovframework/com/cop/tpl/right_gap.gif' />" width="9" height="9" alt="여백이미지" /></td>
							</tr>
							<tr>
								<td height="9" style="background-image : url(${pageContext.request.contextPath}/images/egovframework/com/cop/tpl/right_gap.gif);"><img src="<c:url value='/images/egovframework/com/cop/tpl/right_gap.gif' />" width="9" height="9" alt="여백이미지" /></td>
					...
					<tr>
						<td><table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td height="22" align="right">
									<a href="javascript:fn_egov_loadArticleList('<c:out value="${bbsList[1].bbsId}" />','<c:out value="${bbsList[1].bbsAttrbCode}" />');"><img src="<c:url value='/images/egovframework/com/cop/tpl/more_08.gif' />" width="36" height="12" alt="더보기이미지아이콘" /></a>
								</td>
							</tr>
						</table></td>
					</tr>
					...
					<tr>
						<td><table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td height="22" align="right">
									<a href="javascript:fn_egov_loadArticleList('<c:out value="${bbsList[2].bbsId}" />','<c:out value="${bbsList[2].bbsAttrbCode}" />');"><img src="<c:url value='/images/egovframework/com/cop/tpl/more_08.gif' />" width="36" height="12" alt="더보기이미지아이콘" /></a>
								</td>
							</tr>
						</table></td>
					</tr>
					...
					<tr>
						<td><table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr>
								...
								<td height="22" align="right">
									<a href="javascript:fn_egov_loadArticleList('<c:out value="${bbsList[3].bbsId}" />','<c:out value="${bbsList[3].bbsAttrbCode}" />');"><img src="<c:url value='/images/egovframework/com/cop/tpl/more_08.gif' />" width="36" height="12" alt="더보기이미지아이콘" /></a>
								</td>
							</tr>
						</table></td>
					</tr>
