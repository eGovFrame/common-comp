<%--
  Class Name : EgovOnlineManualModify.jsp
  Description : 온라인메뉴얼 관리 수정 페이지
...
function fn_egov_save_OnlineManual(){
	...
	if(confirm("<spring:message code="common.save.msg" />")){
		varFrom.action =  "<c:url value='/uss/olh/omm/updtOnlineManual.do' />";
...
<!--  상단타이틀 -->
<form:form commandName="onlineManual" name="onlineManual" action="${pageContext.request.contextPath}/uss/olh/omm/updtOnlineManual.do" method="post" enctype="multipart/form-data" >
<!-- ----------------- 상단 타이틀  영역 -->
<table width="100%" cellpadding="8" class="table-search" border="0" summary="상단 타이틀을 제공한다.">
 <tr>
  <td width="100%"class="title_left">
   <img src="${ImgUrl}icon/tit_icon.gif" width="16" height="16" hspace="3" align="middle" alt=" ">&nbsp;온라인메뉴얼관리 수정</td>
 </tr>
</table>
<!--  줄간격조정  -->
