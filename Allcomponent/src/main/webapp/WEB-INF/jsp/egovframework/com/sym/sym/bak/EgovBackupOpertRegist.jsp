...
function fn_egov_save(){
    var varForm = document.getElementById("backupOpert");
    varForm.action =  "/sym/sym/bak/addBackupOpert.do";
...
<!-- 상단타이틀 -->
<form:form commandName="backupOpert"  action="/sym/sym/bak/addBackupOpert.do" method="post">
...
<table width="100%" cellpadding="8" class="table-search" border="0" summary="상단 타이틀을 제공한다.">
 <tr>
  <td width="100%"class="title_left">
   <h1><img src="${imgUrl}icon/tit_icon.gif" width="16" height="16" hspace="3" style="vertical-align: middle" alt="">&nbsp;백업작업 등록</h1></td>
 </tr>
</table>
<!--  줄간격조정  -->
...
<table width="100%" border="0" cellpadding="0" cellspacing="1" class="table-register" summary="백업작업등록을 위한 테이블.">
  ...
  <tr>
    <th width="20%" height="23" class="required_text" nowrap ><label for="cmprsSe">압축구분</label><img src="${imgUrl}icon/required.gif" alt="필수입력" title="필수입력" width="15" height="15"></th>
    <td>
