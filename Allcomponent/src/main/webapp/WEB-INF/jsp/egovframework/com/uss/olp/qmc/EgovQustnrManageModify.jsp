...
<div class="title_left" style="width:100%;margin:0 0 0 0;">
	<h1><img src="<c:out value="${ImgUrl}" />icon/tit_icon.gif" width="16" height="16" hspace="3" style="vertical-align:middle; display:inline-block;" alt="제목아이콘이미지">&nbsp;설문관리 수정</h1>
</div>
...
<caption>수정 을 제공한다</caption>
  ...
  <tr>
    ...
    <td>
    	<form:textarea path="qestnrWritngGuidanceCn" rows="3" cols="20" cssClass="txaClass" title="설문작성안내내용 입력"/>
