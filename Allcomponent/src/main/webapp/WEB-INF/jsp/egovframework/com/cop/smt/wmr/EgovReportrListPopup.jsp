...
<!-- ------------------------------------------------------------------ iframe -->
<iframe id="ReportrListView" src="<c:url value='/cop/smt/wmr/selectReportrList.do' />" width="100%" height="475px" frameborder="0" scrolling="no" marginwidth="0" marginheight="0" title="보고자목록">
</iframe>
</DIV>
</body>
</html>
