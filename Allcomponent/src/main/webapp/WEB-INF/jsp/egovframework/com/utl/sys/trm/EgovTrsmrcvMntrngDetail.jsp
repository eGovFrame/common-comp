...
function fn_egov_update_view(){
    ...
    varForm.action = "/utl/sys/trm/getTrsmrcvMntrngForUpdate.do";
    varForm.submit();
}
/* ********************************************************
 * 삭제 처리
 ******************************************************** */
 function fn_egov_delete(){
        ...
        if(confirm("<spring:message code='common.delete.msg' />")){
            vForm.action = "/utl/sys/trm/deleteTrsmrcvMntrng.do";
            vForm.submit();
        }
}
</script>
...
<form name="trsmrcvMntrngForm"  id="trsmrcvMntrngForm" action="/utl/sys/trm/getTrsmrcvMntrng.do" method="post">
