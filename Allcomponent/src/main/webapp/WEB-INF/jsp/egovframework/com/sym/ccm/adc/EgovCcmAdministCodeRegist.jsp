...
<table width="700" cellpadding="8" class="table-search" border="0">
 <tr>
  <td width="100%"class="title_left"><h1 class="title_left">
   <img src="<c:url value='/images/egovframework/com/cmm/icon/tit_icon.gif' />" width="16" height="16" hspace="3" style="vertical-align: middle" alt="제목아이콘이미지">&nbsp;행정코드 등록</h1></td>
 </tr>
</table>
<!-- 줄간격조정  -->
...
<CAPTION style="display: none;">행정코드 등록</CAPTION>
  ...
  <tr>
    <th scope="row" width="20%" height="23" class="required_text" nowrap >폐기일자<img src="<c:url value='/images/egovframework/com/cmm/icon/no_required.gif' />" alt="선택입력표시"  width="15" height="15"></th>
    <td width="80%" nowrap>
  ...
  <tr>
    <th scope="row" width="20%" height="23" class="required_text" nowrap >상위행정구역코드<img src="<c:url value='/images/egovframework/com/cmm/icon/no_required.gif' />" alt="선택입력표시"  width="15" height="15"></th>
    <td width="80%" nowrap>
